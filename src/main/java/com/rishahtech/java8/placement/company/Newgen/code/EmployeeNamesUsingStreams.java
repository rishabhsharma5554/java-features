...
public class EmployeeNamesUsingStreams {
    public static void main(String[] args) {
        ...
        //From a List of Employee Object create one more List with Only Names of All Employees
        List<String> allEmployeeNames = employeeList.stream().map(emp -> emp.getName()).collect(Collectors.toList());
